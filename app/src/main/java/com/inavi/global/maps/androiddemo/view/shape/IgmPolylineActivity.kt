...
class IgmPolylineActivity : IgmMapFragmentActivity<ActivityIgmShapeRemoveBinding>(
    ...
    override fun init(savedInstanceState: Bundle?) {
        ...
        binding.rmShape.text = getString(R.string.igm_remove_polyline)
    }
    ...
    override fun onMapReady(igmMap: IgmMap) {
        ...
        val polyline1 = IgmPolyline().apply {
        ...
        val polyline2 = IgmPolyline().apply {
